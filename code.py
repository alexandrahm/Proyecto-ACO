...
const int echoPin = 5;
long duration;
int ledPin = 3; // Pin digital donde está conectado el LED rojo
int tiltPin = 2; // Pin digital donde está conectado el sensor de inclinación
...
void loop() {
  ...
  // Control del LED rojo según el estado del sensor de inclinación
